...
- [[requirement_argocd]] <<requirement_argocd,argocd>> (~> 4.0)

- [[requirement_aws]] <<requirement_aws,aws>> (~> 4.0)
...
- [[requirement_utils]] <<requirement_utils,utils>> (~> 1.0)

=== Providers

The following providers are used by this module:

- [[provider_aws]] <<provider_aws,aws>> (~> 4.0)
